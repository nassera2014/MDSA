...
data = pd.read_csv('C:/Users/admin/Desktop/Data/dataset.csv')
...
X_train, X_test, Y_train, Y_test = train_test_split(text_list, y, test_size=0.2, random_state=45)
...
model3.fit(X_train_indices, Y_train, batch_size=64, epochs=20)
...
model4.fit(X_train_indices, Y_train, batch_size=64, epochs=20)
